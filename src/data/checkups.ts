...
export const CHECKUPS: Checkup[] = [
  {
    ...
    seoTitle: "ReAge Energy — чекап при усталости: 7 показателей на энергию",
    seoDescription:
      "Чекап ReAge Energy: ОАК + СОЭ + лейкоцитарная формула, ферритин, витамин D, витамин B12, ТТГ, глюкоза и HbA1c за 5 990 ₽. Анализы в LabQuest, результаты с разбором в ReAge за 1–2 дня.",
    markers: [
      {
  ...
  },
  {
    ...
    seoTitle: "ReAge Thyroid — чекап щитовидной железы: ТТГ, Т4, АТ-ТПО",
    seoDescription:
      "Чекап ReAge Thyroid за 3 990 ₽: ТТГ, Т4 свободный и антитела к тиреопероксидазе. Анализы в LabQuest, понятная расшифровка с рекомендациями в ReAge за 1–2 дня.",
    markers: [
  ...
  },
  {
    ...
    seoTitle: "ReAge Iron — чекап на железодефицит: ферритин и обмен железа",
    seoDescription:
      "Чекап ReAge Iron за 5 990 ₽: общий анализ крови, ферритин, железо сывороточное, трансферрин, ОЖСС и коэффициент насыщения. Анализы в LabQuest, разбор в ReAge за 1–2 дня.",
    markers: [
  ...
  },
  {
    ...
    seoTitle: "ReAge CardioRisk 40+ — чекап сердца и сосудов, ApoB и Lp(a)",
    seoDescription:
      "Чекап ReAge CardioRisk 40+ за 7 990 ₽: липидный профиль, non-HDL, Lp(a), ApoB, hs-CRP, глюкоза, HbA1c, креатинин и eGFR. Анализы в LabQuest, разбор в ReAge за 1–2 дня.",
    markers: [
  ...
  },
  {
    ...
    seoTitle: "ReAge Metabolic — чекап обмена веществ: инсулин и HOMA-IR",
    seoDescription:
      "Чекап ReAge Metabolic за 6 990 ₽: глюкоза, HbA1c, инсулин, HOMA-IR, триглицериды, ЛПВП, АЛТ, АСТ, ГГТ, креатинин и eGFR. Анализы в LabQuest, разбор в ReAge за 1–2 дня.",
    markers: [
      { title: "Глюкоза", description: "уровень сахара сейчас", icon: Sparkles },
      { title: "HbA1c", description: "средний сахар за три месяца", icon: Gauge },
      { title: "Триглицериды", description: "жиры крови и питание", icon: Leaf },
  ...
  },
  {
    ...
    seoTitle: "ReAge Liver & Fibrosis — чекап печени: АЛТ, АСТ, ГГТ и FIB-4",
    seoDescription:
      "Чекап ReAge Liver & Fibrosis за 4 990 ₽: АЛТ, АСТ, ГГТ, щелочная фосфатаза, билирубин, альбумин, ОАК с тромбоцитами и расчётный FIB-4. Анализы в LabQuest, разбор в ReAge.",
    markers: [
      { title: "АЛТ", description: "состояние клеток печени", icon: FlaskConical },
      { title: "АСТ", description: "печень и мышцы", icon: Beaker },
      { title: "ГГТ", description: "желчный отток и нагрузка", icon: Droplet },
  ...
  },
  {
    ...
    seoTitle: "ReAge Kidney Risk — чекап почек: креатинин, eGFR и ACR",
    seoDescription:
      "Чекап ReAge Kidney Risk за 4 990 ₽: креатинин, eGFR, общий анализ мочи и соотношение альбумин/креатинин (ACR). Анализы в LabQuest, понятная расшифровка в ReAge.",
    markers: [
      { title: "Креатинин", description: "нагрузка на почки", icon: Beaker },
      { title: "eGFR", description: "скорость фильтрации почек", icon: Waves },
  ...
  },
  {
    ...
    seoTitle: "ReAge Base 40+ — базовый ежегодный чекап после 40 лет",
    seoDescription:
      "Чекап ReAge Base 40+ за 7 990 ₽: ОАК, глюкоза, HbA1c, липидный профиль, АЛТ, АСТ, ГГТ, креатинин, eGFR и ТТГ. Анализы в LabQuest, понятная расшифровка в ReAge за 1–2 дня.",
    markers: [
