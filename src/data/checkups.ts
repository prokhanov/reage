...
const SUBTITLE = "с понятной расшифровкой и персональными рекомендациями";
...
export const CHECKUPS: Checkup[] = [
  ...
  },
  {
    ...
    leadBullets: [
      "Слоятся ногти, выпадают волосы или сохнет кожа",
      "Часто простужаетесь или долго восстанавливаетесь",
      "Пьёте витамины наугад и не знаете, помогает ли",
      "Витамины и минералы ещё не проверяли ни разу",
    ],
