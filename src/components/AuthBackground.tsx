...
export function AuthBackground() {
  return (
    <>
      ...
      {/* Пятно справа внизу */}
      <div 
        className="absolute bottom-[-100px] right-[15%] w-[550px] h-[550px] bg-primary-glow/18 rounded-full blur-[110px] animate-float-x" 
      ...
      <div 
        className="absolute top-[45%] right-[25%] w-[350px] h-[350px] bg-primary/15 rounded-full blur-[90px] animate-float-y" 
