...
export function HeroSection() {
  ...
  return <section className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 container mx-auto px-4 md:py-32 py-[10px]">
        <div className="max-w-5xl mx-auto text-center">
          ...
          animationDelay: '0.2s'
        }}>Регулярно берем анализы у вас дома и предоставляем самый глубокий отчет по всем системам организма, факторам риска и биологическому возрасту в динамике и с профессиональным сопровождением
        </p>
