...
export function HeroSection() {
  ...
  return <section className="relative flex items-center justify-center overflow-hidden bg-background">
      ...
      {/* Content */}
      <div className="relative z-10 container mx-auto px-4 pt-24 pb-14 md:pt-28 md:pb-18">
        <div className="max-w-5xl mx-auto text-center flex flex-col items-center gap-5 md:gap-6">
          {/* Badge */}
