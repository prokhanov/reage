...
const biomarkerCategories = [
  {
    ...
    insights: ["Откуда берётся постоянная усталость", "Насколько эффективно ваши клетки вырабатывают энергию", "Есть ли скрытые дефициты витаминов и минералов", "Как быстро организм восстанавливается после нагрузок"],
  ...
  },
  {
    ...
    insights: ["Насколько эффективно ваши почки фильтруют кровь и выводят токсины", "Задерживается ли в организме лишняя жидкость, создавая нагрузку на сердце и сосуды", "Полный анализ мочи для оценки функции почек", "Состояние минерального обмена"],
