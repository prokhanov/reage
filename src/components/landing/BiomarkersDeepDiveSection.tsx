...
const biomarkerCategories = [
  {
    ...
    insights: ["Откуда берётся постоянная усталость", "Насколько эффективно клетки производят энергию", "Есть ли скрытые дефициты витаминов и минералов", "Как быстро организм восстанавливается после нагрузок"],
