...
const biomarkerCategories = [
  ...
  },
  {
    ...
    insights: ["Как работает ваша иммунная защита", "Есть ли скрытое хроническое воспаление", "Имеются ли признаки аутоиммунных процессов", "Риски нарушений свёртывания крови и тромбозов"],
  ...
  },
  {
    ...
    risks: ["Нарушение функции печени", "Жировой гепатоз", "Фиброз печени", "Токсическая нагрузка", "Нарушение детоксикации", "Подагра", "Нарушение белкового обмена", "Почечная недостаточность", "Нефропатия", "Нарушение электролитного баланса", "Нарушение водно-солевого баланса", "Риск мочекаменной болезни", "Дефицит кальция"]
  },
  {
    id: "energy",
