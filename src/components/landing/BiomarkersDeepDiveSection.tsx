...
const biomarkerCategories = [
  ...
  },
  {
    ...
    insights: ["Как выглядит ваш липидный профиль в деталях", "В каком состоянии ваша сосудистая стенка", "Соотношение «плохого» и «хорошего» холестерина", "Есть ли скрытые маркеры, указывающие на сердечно-сосудистые заболевания"],
  ...
  },
  {
    ...
    insights: ["Полная картина гормонального фона", "Как работает щитовидная железа и есть ли аутоиммунные риски", "Уровень хронического стресса по кортизолу и DHEA-S", "Баланс половых гормонов и их влияние на самочувствие"],
  ...
  },
  {
    ...
    insights: ["Насколько эффективно ваши почки фильтруют кровь и выводят токсины", "Баланс ключевых электролитов в организме", "Задерживается ли в организме лишняя жидкость, создавая нагрузку на сердце и сосуды", "Состояние минерального обмена"],
