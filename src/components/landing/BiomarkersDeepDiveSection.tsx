...
const biomarkerCategories = [
  ...
  },
  {
    ...
    image: systemImmune,
    markers: ["Эритроциты", "Гемоглобин", "Гематокрит", "MCV", "MCH", "MCHC", "RDW", "Тромбоциты", "Лейкоциты", "Нейтрофилы", "Лимфоциты", "Моноциты", "Эозинофилы", "Базофилы", "СОЭ", "CRP (hs-CRP)", "IgM", "IgG", "IL-6", "TNF-α"],
    insights: ["Как работает ваша иммунная защита", "Есть ли скрытое хроническое воспаление", "Имеются ли в организме признаки аутоиммунных процессов", "Риски нарушений свёртывания крови и тромбозов"],
  ...
  },
  {
    ...
    image: systemEnergy,
    markers: ["Глюкоза", "HbA1c", "Инсулин", "HOMA-IR", "ЛДГ", "Альбумин", "Магний", "КФК", "Витамин B12", "Фолиевая кислота (B9)", "Цинк", "Селен", "Лактат", "Коэнзим Q10", "Малоновый диальдегид", "Индекс окислит. стресса"],
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-10 md:mb-12">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto animate-fade-in">
            Эти 5 систем охватывают всё здоровье: сердце и сосуды, иммунитет, гормоны, метаболизм и клеточную энергию — и мы анализируем их вместе, а не по отдельности
          </p>
        </div>
