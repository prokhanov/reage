...
const biomarkerCategories = [
  ...
  },
  {
    ...
    markers: ["Креатинин", "Мочевина", "Цистатин С", "Натрий", "Калий", "Хлор", "Кальций", "Фосфор", "pH мочи", "Удельный вес мочи", "Белок в моче", "Глюкоза в моче", "Кетоны в моче", "Уробилиноген", "Билирубин в моче", "Гемоглобин в моче", "Нитриты в моче", "Лейкоциты в моче", "Эритроциты в моче"],
    insights: [
