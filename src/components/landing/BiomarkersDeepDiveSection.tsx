...
const biomarkerCategories = [
  ...
  },
  {
    ...
    insights: ["Комплексная оценка состояния вашего гормонального фона", "Как работает ваша щитовидная железа и есть ли аутоиммунные риски", "Уровень хронического стресса по состоянию надпочечников и кортизолу", "Баланс половых гормонов и их влияние на самочувствие"],
