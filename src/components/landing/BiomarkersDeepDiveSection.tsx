...
const biomarkerCategories = [
  {
    ...
    image: systemHeart,
    markers: ["Общий холестерин", "ЛПВП", "ЛПНП", "Триглицериды", "ЛПОНП", "не-HDL холестерин", "Индекс атерогенности", "Ферритин", "ApoA1", "ApoB", "ApoB/ApoA1", "Гомоцистеин", "Lp(a)", "Железо", "Медь", "hs-Troponin I", "NT-proBNP"],
  ...
  },
  {
    ...
    markers: ["ТТГ", "Т4 свободный", "Т3 свободный", "Анти-ТПО", "Анти-ТГ", "TRAb", "Тестостерон", "Эстрон", "SHBG", "Кортизол", "DHEA-S", "Витамин D", "IGF-1"],
