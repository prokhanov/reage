...
const biomarkerCategories = [
  {
    ...
    markers: ["Глюкоза", "HbA1c", "Инсулин", "HOMA-IR", "ЛДГ", "Коэнзим Q10", "Малоновый диальдегид", "Антиоксидантный статус", "Магний", "B12", "B9 (фолат)", "Цинк", "Селен", "Альбумин", "Лактат", "Витамин A", "Витамин E", "Витамин K1", "Каротин"],
    insights: [
      "Почему постоянная усталость и нет сил",
      "Достаточно ли энергии производят ваши клетки",
      "Есть ли скрытые дефициты витаминов и минералов",
      "Как быстро вы восстанавливаетесь после нагрузки",
      "Насколько защищены клетки от оксидативного стресса",
      "Хватает ли ресурсов для нормального обмена веществ"
    ],
  },
  {
    id: "cardio",
    ...
    markers: ["Общий холестерин", "ЛПВП", "ЛПНП", "Триглицериды", "ЛПОНП", "ApoA1", "ApoB", "ApoB/ApoA1", "не-HDL холестерин", "Индекс атерогенности", "Гомоцистеин", "Lp(a)", "Ферритин", "Железо", "Медь", "NT-proBNP", "КФК", "Трансферрин"],
    insights: [
      "Реальный риск атеросклероза и инфаркта",
      "Состояние сосудистой стенки",
      "Баланс «плохого» и «хорошего» холестерина",
      "Скрытые маркеры сердечного риска (ApoB, Lp(a))",
      "Достаточно ли железа и как оно усваивается",
      "Есть ли повреждение сердечной мышцы"
    ],
  },
  {
    id: "immune",
    ...
    markers: ["Гемоглобин", "Эритроциты", "Гематокрит", "MCV", "MCH", "MCHC", "RDW-CV", "RDW-SD", "Лейкоциты", "Нейтрофилы", "Нейтрофилы %", "Лимфоциты", "Лимфоциты %", "Моноциты", "Моноциты %", "Эозинофилы", "Эозинофилы %", "Базофилы", "Базофилы %", "Тромбоциты", "MPV", "PCT", "PDW", "СОЭ", "CRP (hs)", "IL-6", "TNF-α", "IgM", "IgG"],
    insights: [
      "Есть ли хроническое воспаление — главный ускоритель старения",
      "Как работает врождённый и адаптивный иммунитет",
      "Есть ли скрытые инфекции или аллергические процессы",
      "Риск аутоиммунных заболеваний",
      "Качество и объём красной крови (анемия)",
      "Функция тромбоцитов и риск кровотечений"
    ],
  },
  {
    id: "endocrine",
    ...
    markers: ["ТТГ", "Т4 свободный", "Т3 свободный", "Anti-TPO", "Anti-TG", "TRAb", "Тестостерон", "Эстрадиол", "Эстрон", "Эстриол", "SHBG", "Кортизол", "DHEA-S", "Витамин D", "IGF-1"],
    insights: [
      "Полная картина щитовидной железы включая антитела",
      "Гормональный баланс (половые гормоны, стресс)",
      "Уровень хронического стресса по кортизолу и DHEA-S",
      "Достаточно ли витамина D для иммунитета и костей",
      "Есть ли инсулинорезистентность (предиабет)",
      "Факторы роста и восстановления тканей"
    ],
  },
  {
    id: "metabolism",
    ...
    markers: ["ALT", "AST", "GGT", "Билирубин", "ALP", "Общий белок", "Мочевая кислота", "Фибриноген", "Протромбиновое время", "Тромбиновое время", "МНО", "АЧТВ"],
    insights: [
      "Как работает печень и справляется ли с нагрузкой",
      "Эффективность детоксикации организма",
      "Состояние белкового обмена и нутритивный статус",
      "Риск подагры и гиперурикемии",
      "Полная коагулограмма — свёртываемость крови",
      "Баланс между кровотечением и тромбозом"
    ],
  },
  {
    id: "kidneys",
    ...
    markers: ["Креатинин", "Мочевина", "Натрий", "Калий", "Хлор", "Кальций", "Фосфор", "pH мочи", "Плотность мочи", "Белок мочи", "Глюкоза мочи", "Кетоны мочи", "Уробилиноген", "Билирубин мочи", "Гемоглобин мочи", "Нитриты мочи", "Лейкоциты мочи", "Эритроциты мочи"],
    insights: [
      "Функция почек и скорость клубочковой фильтрации",
      "Баланс электролитов — натрий, калий, кальций, фосфор",
      "Риск мочекаменной болезни и нефропатии",
      "Состояние минерального обмена и костей",
      "Полный анализ мочи — скрытые инфекции и воспаления",
      "Ранние признаки повреждения почек"
    ],
  }
];
