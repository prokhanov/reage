...
const biomarkerCategories = [
  ...
  },
  {
    ...
    insights: ["Комплексная оценка состояния вашего гормонального фона", "Как работает щитовидная железа и есть ли аутоиммунные риски", "Уровень хронического стресса по кортизолу и DHEA-S", "Баланс половых гормонов и их влияние на самочувствие"],
