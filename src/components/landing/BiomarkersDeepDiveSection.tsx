...
const biomarkerCategories = [
  {
    ...
    image: systemHeart,
    markers: ["Общий холестерин", "ЛПВП", "ЛПНП", "Триглицериды", "ЛПОНП", "не HDL-холестерин", "Индекс атерогенности", "ApoA1", "ApoB", "ApoB/ApoA1", "Гомоцистеин", "Lp(a)", "hs-Troponin I", "NT-proBNP", "Фибриноген", "ПТИ", "МНО", "АЧТВ", "Тромбоциты", "MPV", "PDW", "Тромбокрит"],
    insights: ["Как выглядит ваш липидный профиль в деталях", "В каком состоянии ваша сосудистая стенка", "Соотношение «плохого» и «хорошего» холестерина", "Есть ли маркеры, указывающие на риски сердечно-сосудистых заболеваний и тромбозов"],
    risks: ["Риск атеросклероза", "Дислипидемия", "Гиперхолестеринемия", "Риск тромбоза", "Кардиоваскулярный риск", "Гипергомоцистеинемия", "Эндотелиальная дисфункция", "Нарушение липидного профиля", "Нарушение свёртываемости"]
  },
  {
    id: "immune",
    ...
    image: systemImmune,
    markers: ["Лейкоциты", "Нейтрофилы", "Лимфоциты", "Моноциты", "Эозинофилы", "Базофилы", "СОЭ", "CRP (hs-CRP)", "IgM", "IgG", "IL-6", "TNF-α"],
    insights: ["Как работает ваша иммунная защита", "Есть ли скрытое хроническое воспаление", "Имеются ли в организме признаки аутоиммунных процессов", "Уровень системного воспаления старения (inflammaging)"],
    risks: ["Хроническое воспаление", "Системное воспаление", "Снижение иммунитета", "Аутоиммунные риски", "Ускоренное старение"]
  },
  {
    id: "endocrine",
  ...
  },
  {
    ...
    markers: ["ALT", "AST", "GGT", "Билирубин", "ALP", "Общий белок", "Креатинин", "eGFR", "Мочевина", "Натрий", "Калий", "Хлор", "Кальций", "Мочевая кислота", "Альбумин/креатинин мочи (ACR)", "Общий анализ мочи"],
  ...
  },
  {
    ...
    image: systemEnergy,
    markers: ["Глюкоза", "HbA1c", "Инсулин", "HOMA-IR", "ЛДГ", "Альбумин", "Магний", "КФК", "Витамин B12", "Фолиевая кислота (B9)", "Цинк", "Селен", "Лактат", "Коэнзим Q10", "Малоновый диальдегид", "Индекс окислит. стресса", "Эритроциты", "Гемоглобин", "Гематокрит", "MCV", "MCH", "MCHC", "RDW", "Железо", "Ферритин", "Трансферрин", "Насыщение трансферрина", "Медь"],
    insights: ["Откуда берётся постоянная усталость и сонливость", "Насколько эффективно ваши клетки вырабатывают энергию", "Есть ли у вас скрытые дефициты витаминов, минералов и железа", "Как ткани обеспечены кислородом и как быстро организм восстанавливается"],
    risks: ["Инсулинорезистентность", "Преддиабет", "Гипергликемия", "Дефицит B12", "Дефицит магния", "Дефицит цинка", "Дефицит селена", "Оксидативный стресс", "Митохондриальная дисфункция", "Синдром хронической усталости", "Анемия", "Дефицит железа", "Хроническая гипоксия"]
  },
];
