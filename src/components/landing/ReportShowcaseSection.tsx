...
{
  icon: FileText,
  title: "Понятное объяснение результатов",
  description: "Разбираем показатели простым языком без сложных медицинских терминов"
},
{
  icon: TrendingUp,
...
},
{
  ...
  description: "Объясняем сильные и слабые стороны организма и ключевые факторы самочувствия"
},
{
  icon: Pill,
  title: "Факторы, влияющие на старение",
  description: "Показываем, какие показатели могут ускорять старение и ухудшать состояние организма"
},
{
  icon: CheckCircle2,
  title: "Конкретные рекомендации врача",
  description: "Персональный план действий: витамины, минералы, питание и дополнительные обследования"
}];
