...
},
{
  ...
  description: "Персональный план действий: витамины и минералы, с указанием дозировки, кратности и длительностью приема. Рекомендации по питанию и дополнительным обследованиям"
}];
