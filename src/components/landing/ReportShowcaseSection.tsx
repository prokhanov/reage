...
const reportFeatures = [
  ...
  {
    icon: CheckCircle2,
    title: "Конкретные информационные рекомендации",
    description: "Информационные материалы по БАДам, витаминам, питанию и образу жизни. При необходимости рекомендуем обратиться к врачу для дополнительных обследований",
  },
];
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16 md:mb-20 animate-fade-in">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
            Дорожная карта вашего здоровья: расшифровка всех показателей и персональные информационные рекомендации
          </p>
        </div>
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-10">
            {reportFeatures.map((feature, index) => {
              ...
              return (
                <div
                  key={feature.title}
                  className="flex gap-4 p-5 rounded-xl bg-card/50 border border-border/50 backdrop-blur-sm animate-fade-in transition-colors hover:bg-card/80"
