...
const problems = [
  {
    ...
    description: "Лабораторные нормы формируются по статистике большой группы людей. В эти диапазоны часто попадают показатели людей с уже существующими заболеваниями. Поэтому\n«в пределах референса» не всегда означает оптимальное состояние организма",
  },
  {
