...
const problems = [
  {
    ...
    description: "Лабораторные нормы формируются по статистике большой группы людей. В эти диапазоны часто попадают показатели людей с уже существующими проблемами. Поэтому «в пределах референса» не всегда означает оптимальное состояние организма.",
  },
  {
    icon: <Link2 className="w-5 h-5" />,
    title: "Каждый показатель нельзя оценивать отдельно",
    description: "В обычном чекапе анализы смотрят по одному. Но здоровье определяется взаимосвязями между показателями: гормонами, метаболизмом, воспалением, липидным обменом. Без анализа этих связей многие риски остаются незаметными.",
  },
  {
