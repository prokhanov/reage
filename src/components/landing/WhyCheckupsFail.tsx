...
const problems = [
  {
    ...
    description: "Лабораторные нормы формируются на основе статистики большой группы людей. В эти диапазоны попадают показатели людей с уже существующими заболеваниями. Поэтому «в пределах референса» не всегда означает оптимальное состояние организма",
  },
  {
    icon: <Link2 className="w-5 h-5" />,
    title: "Показатели нельзя оценивать отдельно",
    description: "В обычном чекапе анализы смотрят изолированно. Но организм – это единая система. Без анализа взаимосвязей вы видите только цифры, но не понимаете, что на самом деле происходит с вашим организмом и какие риски остаются незаметными",
  },
  {
    icon: <Camera className="w-5 h-5" />,
    title: "Разовый чекап показывает только момент времени",
    description: "Это фактически статичный замер состояния организма.\nБез повторного мониторинга невозможно увидеть динамику показателей и понять, улучшается ли состояние или показатели постепенно ухудшаются. Здоровье – это процесс, и отслеживать его нужно в динамике",
  },
  {
          ...
          <div className="relative p-6 md:p-8 rounded-2xl border border-primary/20 bg-gradient-to-br from-primary/5 via-card/80 to-primary/5 backdrop-blur-sm">
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
                Мы анализируем все показатели в системе, сравниваем с оптимальными диапазонами, показываем динамику и&nbsp;даём конкретный план действий&nbsp;— не просто цифры,<br />а&nbsp;дорожную карту вашего здоровья
              </p>
            </div>
          </div>
        </div>
