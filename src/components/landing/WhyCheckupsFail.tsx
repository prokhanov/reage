...
const problems = [
  {
    ...
    description: "Лабораторные нормы формируются на основе статистики большой группы людей. В эти диапазоны часто попадают показатели людей с уже существующими заболеваниями. Поэтому\n«в пределах референса» не всегда означает оптимальное состояние организма",
  },
  {
  ...
  },
  {
    ...
    description: "Это фактически одна фотография организма. Без повторного мониторинга невозможно увидеть динамику показателей и понять, улучшается ли состояние или показатели постепенно ухудшаются. Здоровье – это процесс, и отслеживать его нужно в динамике",
  },
  {
