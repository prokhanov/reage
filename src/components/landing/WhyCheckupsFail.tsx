...
const problems = [
  ...
  },
  {
    ...
    description: "Без повторного мониторинга невозможно увидеть динамику показателей и понять, улучшается ли состояние или показатели постепенно ухудшаются. Здоровье – это процесс, и отслеживать его нужно в динамике",
  },
  {
