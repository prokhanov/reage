...
const steps = [
  {
    ...
    subtitle:
      "Регулярно берём анализы на дому или в клинике и проверяем 100+ показателей ключевых систем организма",
  },
  {
    num: "02",
    image: stepAnalysis,
...
export function HowItWorksBlock() {
  return (
    <section id="how-it-works" className="relative pt-8 md:pt-12 pb-4 md:pb-6 overflow-hidden scroll-mt-20">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[72rem] px-4 sm:px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 md:mb-14">
          <h2
            className="font-display text-[1.9rem] font-semibold md:text-4xl leading-tight animate-fade-in"
