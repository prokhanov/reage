...
const STEPS: Step[] = [
  ...
  { num: "04", icon: ListChecks,  title: "Внедряете рекомендации", subtitle: "Персональный план действий" },
  { num: "05", icon: TrendingUp,  title: "Отслеживаете динамику",  subtitle: "Показатели идут вверх" },
];
