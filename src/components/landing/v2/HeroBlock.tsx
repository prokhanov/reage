...
import { ArrowRight, Moon, Sun, MapPin } from "lucide-react";
...
export function HeroBlock() {
  ...
  return (
    <section className="relative flex items-center justify-center overflow-hidden bg-background min-h-[600px] md:min-h-[700px]">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 50% 20% at 48% 50%, hsl(200 90% 65% / 0.2) 0%, transparent 60%)",
          }}
        />
      </div>
