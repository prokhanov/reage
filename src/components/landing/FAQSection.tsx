...
export function FAQSection() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Обычные лаборатории дают только цифры и широкие референсные значения. Мы же анализируем оптимальные диапазоны, готовим подробный отчёт с расшифровками, отслеживаем динамику и даём персональные информационные рекомендации по образу жизни, способные повлиять на показатели.",
    },
    {
