...
export function FAQSection() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Вы можете выбрать удобный формат: медсестра приедет к вам домой в удобное время, или вы можете самостоятельно приехать в клинику.. Процедура занимает около 10-15 минут. Используются только одноразовые стерильные инструменты, образцы сразу отправляются в аккредитованную лабораторию для исследования.",
    },
    {
