...
export function BusinessHero({ onCta }: { onCta: () => void }) {
  ...
  return (
    <section className="relative overflow-hidden bg-background">
      ...
      <header className="relative z-20 mx-auto w-full max-w-[74rem] px-4 flex items-center justify-between gap-3 pt-5">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[74rem] px-4 pt-12 pb-14 md:pt-20 md:pb-20">
