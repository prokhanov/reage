...
export function CostOfInactionBlock() {
  return (
    <section className="relative py-12 md:py-16 overflow-hidden border-y border-border/40 bg-muted/10">
      <div className="relative z-10 container mx-auto px-4 md:px-4 lg:px-10 xl:px-16 grid lg:grid-cols-[0.9fr_1.1fr] gap-12 items-start">
        <div>
...
export function BusinessValueBlock() {
  return (
    <section className="relative py-12 md:py-16 overflow-hidden">
      <div className="relative z-10 container mx-auto px-4 md:px-4 lg:px-10 xl:px-16">
