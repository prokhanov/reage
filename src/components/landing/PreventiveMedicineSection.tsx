          ...
          <div className="group relative animate-fade-in" style={{ animationDelay: '0.3s' }}>
            ...
            <div className="relative h-full rounded-3xl border border-primary/20 bg-gradient-to-b from-card to-card/90 p-8 md:p-10 shadow-2xl shadow-primary/5">
              ...
              <div className="space-y-5 text-muted-foreground leading-relaxed">
                ...
                <p>
                  Организм часто молчит до последнего. Повышенный инсулин не болит, но через 5–10 лет может привести к диабету. Высокое давление годами не даёт симптомов — пока не случится инсульт. Дефицит витамина D проявляется усталостью, которую списывают на стресс.
                </p>
                <div className="rounded-2xl bg-primary/5 border border-primary/10 p-5">
                  <p className="text-sm">
                    <strong className="text-foreground">Задача превентивной медицины</strong> — увидеть эти изменения на самой ранней стадии, когда всё ещё можно скорректировать витаминами, питанием и изменением образа жизни, <strong className="text-foreground">без тяжёлых лекарств</strong>.
                  </p>
                </div>
              </div>
            </div>
