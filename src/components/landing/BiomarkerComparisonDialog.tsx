...
const DIRECTIONS: Direction[] = [
  ...
  { title: "Сахар и инсулинорезистентность", hint: "риск диабета 2 типа, набора веса, метаболического синдрома", levels: { basic: 1, plus: 1, expert: 1 } },
  { title: "Печень и детоксикация", hint: "переработка алкоголя, лекарств, гормонов, токсинов", levels: { basic: 1, plus: 1, expert: 1 } },
