...
const steps = [
  {
    ...
    items: [
      "Вы оформляете заявку онлайн",
      "Приезжаем к вам в удобное время",
      "Забор крови занимает 10–15 минут",
      "Доставляем материал в лабораторию для исследования",
    ],
  },
  {
    ...
    items: [
      ...
      "Объясняем, как показатели влияют на ваше самочувствие, энергию и здоровье ",
      "Выделяем ваш биологический возраст и факторы риска ",
      "Готовим отчёт с полной расшифровкой ваших показателей",
    ],
  },
  {
    ...
    items: [
      "Формируем для вас чёткий план действий для улучшения показателей: подбор витаминов и минералов, рекомендации по питанию и режиму",
      "Если анализы выявляют отклонения, требующие внимания, мы порекомендуем обратиться к профильному врачу",
      "Все наши рекомендации конкретны и выполнимы — никакой «воды»",
      "Если останутся вопросы, вы можете задать их нашему врачу",
    ],
  },
  {
    ...
    items: [
      ...
      "Показываем изменение ваших показателей: вы видите, что улучшается, а над чем ещё надо поработать",
