...
const steps = [
  ...
  },
  {
    ...
    items: [
      "Формируем для вас чёткий план действий для улучшения показателей",
      "Подбираем для вас витамины и минералы, даем рекомендации по питанию и режиму",
  ...
  },
  {
    ...
    items: [
      ...
      "Показываем изменение ваших показателей: что улучшается, а над чем ещё надо поработать",
