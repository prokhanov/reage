  ...
  const plans = [
    {
      ...
      price: "75 000₽",
      period: "год",
      description: "Базовый, но умный чек-ап. 46 показателей, которые показывают, как работает обмен веществ, сердце, печень, почки, и гормональный фон. Подходит для регулярного трекинга здоровья и раннего выявления рисков — до появления симптомов.",
      badge: "Старт",
      biomarkers: "46",
