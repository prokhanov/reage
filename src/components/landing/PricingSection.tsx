...
{ emoji: "🔄", name: "Метаболизм и Детоксикация", markers: ["Креатинин", "Мочевина", "Билирубин общий", "Общий белок", "Альбумин", "Мочевая кислота", "ГГТ", "Щелочная фосфатаза", "Калий", "Натрий"] }];
...
{ emoji: "🔄", name: "Метаболизм и Детоксикация", markers: ["Креатинин", "Мочевина", "Билирубин общий", "Общий белок", "Альбумин", "Мочевая кислота", "ГГТ", "Щелочная фосфатаза", "Калий", "Натрий", "Трансферрин", "ОЖСС", "HbA1c"] }];
...
{ emoji: "🔄", name: "Метаболизм и Детоксикация", markers: ["Креатинин", "Мочевина", "Билирубин общий", "Общий белок", "Альбумин", "Мочевая кислота", "ГГТ", "Щелочная фосфатаза", "Калий", "Натрий", "Трансферрин", "ОЖСС", "HbA1c", "Глутатион", "8-OHdG", "МДА"] }];
