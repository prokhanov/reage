...
const steps = [
  {
    ...
    text: "Выбираете клинику, оплачиваете онлайн — всё готово к визиту в лабораторию.",
  ...
  },
  {
    ...
    text: "Присылаем результаты, персональные рекомендации и понятный план действий.",
