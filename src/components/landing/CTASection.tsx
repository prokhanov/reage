        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 pt-16 pb-12">
          <div className="md:col-span-7 lg:col-span-8">
            ...
            <div className="text-sm text-foreground/70 max-w-xl leading-relaxed space-y-3">
              <p>ReAge (ООО «Реэйдж» (ИНН 9704271028) — информационно-аналитический сервис и не оказывает медицинские услуги. Материалы сервиса не являются медицинским заключением, диагнозом или назначением лечения.</p>
              <p>Медицинские услуги (включая забор биоматериала и его исследование) оказываются Партнёром – АО ЛабКвест (ОГРН 1167746128692).</p>
