    ...
    <footer className="relative border-t border-border/40 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 max-w-7xl">
        ...
        <div className="border-t border-border/40 py-10 text-sm text-foreground/70 leading-relaxed space-y-3">
          ...
          <p>Медицинские услуги, включая забор биологического материала и проведение лабораторных исследований, оказываются АО «ЛабКвест» (ОГРН 1167746128692) на основании действующей лицензии на осуществление медицинской деятельности (Лицензия №Л041-01137-77/00311104 от 19.01.2017).</p>
