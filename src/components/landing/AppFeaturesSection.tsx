...
const appFeatures: Record<ShowcaseSection, {
  ...
  reports: {
    ...
    description: "Полный медицинский отчёт по каждому анализу с разбором по системам организма",
    badges: ["8 разделов", "PDF"],
    features: [
      { icon: FileText, text: "Разбор по системам" },
      { icon: Activity, text: "Персональные данные" },
      { icon: Lightbulb, text: "Скачивание в PDF" },
    ],
