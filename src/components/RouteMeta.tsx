...
const ROUTE_META: Record<string, Meta> = {
  "/": {
    ...
    description:
      "Платформа ReAge: анализ биомаркеров, биологический возраст и персональные рекомендации по здоровью и долголетию.",
    canonical: "/",
  },
  // Копия главной (страница мониторинга): canonical ведёт на /, чтобы не плодить дубли в поиске.
  "/monitoring": {
    title: "ReAge — персональный сервис управления здоровьем",
    description:
      "Платформа ReAge: анализ биомаркеров, биологический возраст и персональные рекомендации по здоровью и долголетию.",
  ...
  // Новый лендинг доступен на /main: собственный canonical, т.к. на / теперь мониторинг.
  "/main": {
    title: "ReAge — анализы, которые наконец понятны",
    description:
      "Чекапы ReAge с понятной расшифровкой: биомаркеры, персональные рекомендации и план действий после анализов.",
    canonical: "/main",
  },
  "/example-report": {
  ...
  "/analyses": {
    ...
    description:
      "История загруженных анализов и персональных отчётов ReAge: добавляйте новые исследования и отслеживайте динамику.",
  },
  "/biomarkers": {
...
const PREFIX_META: Array<{ prefix: string; meta: Meta }> = [
  {
    ...
    meta: {
      ...
      description:
        "Подробный персональный отчёт по результату анализа: биомаркеры, интерпретация и персональные рекомендации.",
    },
  },
  {
...
const FALLBACK: Meta = {
  ...
  description:
    "Персональная платформа ReAge: анализ биомаркеров, биологический возраст и стратегия здоровья на год.",
};
