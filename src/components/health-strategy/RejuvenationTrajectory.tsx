          ...
          <div className="flex justify-center my-6">
            <div className="relative w-[210px] h-[210px]">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                ...
                <div className="font-heading text-[56px] font-bold leading-none text-foreground tracking-tight">{healthIndex ?? "—"}</div>
        ...
        <CardContent className="pt-5 pb-4 md:pb-5 px-4 md:px-5 space-y-3">
          <div className="flex items-start justify-between gap-3 flex-wrap">
            ...
            <div className="flex items-center gap-2">
              ...
              {trendDelta != null && (
                <div className={`flex items-center gap-1 text-xs font-heading px-2 py-1 rounded-lg bg-muted ${trendColor}`}>
