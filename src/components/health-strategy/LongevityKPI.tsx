    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogTrigger asChild>
          <Card className="cursor-pointer group hover:scale-[1.02] transition-transform">
        ...
        <DialogContent className="max-w-lg">
          ...
          <div className="text-sm space-y-3 text-foreground/80 leading-relaxed">
            <p><strong>Гибридная формула.</strong> Базовая модель оценивает возраст по 30+ маркерам: HbA1c, креатинин, альбумин, лимфоциты, СРБ, ферритин, витамин D и др. — каждый с собственным «весом старения». Приоритет отдаётся high-impact геромаркерам (OSI, hs-CRP, HbA1c, гомоцистеин, ACR, eGFR, альбумин).</p>
            <p><strong>Якорь — HI=85.</strong> При индексе здоровья 85 биологический возраст совпадает с хронологическим. Ниже 85 — биовозраст растёт, выше — снижается. Шкала симметрична для старения и омоложения.</p>
            <p><strong>AI-поправка (Gemini).</strong> На втором шаге AI учитывает контекст: пол, возраст, сочетания отклонений, тяжесть рисков и приверженность назначениям. Корректировка ограничена ±5 лет от базы.</p>
