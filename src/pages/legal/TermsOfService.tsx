    ...
    <>
      ...
      >
        ...
        <Section icon={<ScrollText className="w-5 h-5" />} title="Предмет соглашения">
          ...
          <p className="mt-3">
            <strong className="text-foreground">4.5.</strong> Сервис не является медицинской информационной системой, не предназначен для ведения медицинской документации, медицинских карт пациентов, оформления медицинских заключений, назначения лечения или оказания медицинской помощи.
          </p>
        </Section>
