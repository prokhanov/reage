...
1. Можно ссылаться на ЛЮБЫЕ данные пациента: биомаркеры, симптомы, назначения, медицинскую историю, вес, жалобы.
2. Пиши evidence ЧЕЛОВЕЧЕСКИМ ЯЗЫКОМ на русском, без технических обозначений. НЕ используй "severity=2/5", "adherence=3%", "Среднее соблюдение назначения '...' = X%" и подобные машинные форматы.
3. Примеры ПРАВИЛЬНОГО evidence:
   - "Повышенный С-реактивный белок (5.2 мг/л) — признак воспаления"
   - "Пациент отмечает дневную сонливость и плохое качество сна"
   - "Низкий уровень витамина D (18 нг/мл)"
   - "Недостаточное соблюдение рекомендаций по питанию и физической активности"
   - "В анамнезе — хронический стресс"
4. Примеры ЗАПРЕЩЁННОГО evidence:
   - "Качество сна severity=2/5"
   - "Среднее соблюдение назначения 'Ежедневная ходьба...' = 0%"
   - "adherence_level = 3%"
5. Блокер должен быть подкреплён хотя бы одним фактом из данных пациента.`;
          ...
          blockers: {
            ...
            items: {
              ...
              properties: {
                ...
                evidence: { type: "array", items: { type: "string" }, description: "Факты из данных пациента на человеческом русском языке. Без технических обозначений вроде severity=X/5 или adherence=X%." },
